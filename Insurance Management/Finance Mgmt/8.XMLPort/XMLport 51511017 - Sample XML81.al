xmlport 51511017 "Sample XML81"
{
    ...
    schema
    {
        textelement(Salary)
        {
            /* tableelement("Procurement Request"; "Procurement Request")
            {
                XmlName = 'procurement_req';
                fieldelement(EMPNO; "Procurement Request".No)
                {
                }
                fieldelement(EMPNAME; "Procurement Request"."TOR File Name")
                {
                }
            } */
        }
