report 51511001 "Petty Cash Voucher"
{
    // version FINANCE

    DefaultLayout = RDLC;
    RDLCLayout = './Finance Mgmt/5.Layouts/Petty Cash Voucher.rdl';
    ...
    dataset
    {
        dataitem("Request Header"; "Request Header")
        {
            ...
            column(Amount_RequestHeader; "Request Header"."Imprest Amount")
            {
            }
            ...
            begin
                ...
                CurrencyCodeText := GLSetups."LCY Code";
                ...
                "Request Header".CALCFIELDS("Request Header".Balance, "Request Header"."Imprest Amount", "Request Header"."Actual Amount",
                "Request Header"."Total Amount Requested", "Request Header"."Claim accounting Balance");
                ...
                AmountInWords := FormatNoTextSure(NumberText, "Request Header"."Imprest Amount", '');
    ...
    var
        ...
        Impamount2: Decimal;
        GLSetups: Record "General Ledger Setup";
    ...
    procedure FormatNoTextSure(var NoText: array[2] of Text[80]; No: Decimal; CurrencyCode: Code[10]): Text[250]
    var
        PrintExponent: Boolean;
        Ones: Integer;
        Tens: Integer;
