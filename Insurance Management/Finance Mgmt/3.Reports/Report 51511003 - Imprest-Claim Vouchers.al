report 51511003 "Imprest-Claim Vouchers"
{
    // version FINANCE

    DefaultLayout = RDLC;
    RDLCLayout = './Finance Mgmt/5.Layouts/Imprest-Claim Vouchers.rdl';
    ...
    dataset
    {
        dataitem("Request Header"; "Request Header")
        {
            ...
            dataitem("Request Lines"; "Request Lines")
            {
                ...
                column(Budget; CashMgtSetup."Current Budget")
                {
                }
            ...
            begin
                ...
                END;*/
                /*
                IF reqheader.GET("Request Header".)
                ...
                IF "Request Header"."Request Date" < 20171005D
                  THEN BEGIN
                ...
                "Request Header".CALCFIELDS("Request Header".Balance, "Request Header"."Imprest Amount", "Request Header"."Actual Amount", "Request Header"."Total Amount Requested");
