table 51513088 "Insure Credit Note"
{
    // version AES-INS 1.0
    ...
    fields
    {
        ...
        {
            CalcFormula = Sum("Insure Credit Note Lines".Amount WHERE("Document Type" = FIELD("Document Type"),
        ...
        {
            CalcFormula = Sum("Insure Credit Note Lines".Amount WHERE("Document Type" = FIELD("Document Type"), "Document No." = FIELD("No."), Tax = CONST(True)));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("Insure Credit Note Lines"."Sum Insured" WHERE("Document Type" = FIELD("Document Type"), "Document No." = FIELD("No.")));
            FieldClass = FlowField;
        }
        ...
        {
            TableRelation = "Instalment Payment Plan"."Payment No" WHERE("Document Type" = FIELD("Document Type"), "Document No." = FIELD("No."));
        }
        ...
        field(128; "Opportunity No."; Code[20])
        {
            ...
            ELSE
            IF ("Document Type" = CONST(Quote)) Opportunity."No." WHERE("Contact No." = FIELD("Contact No."), "Sales Document No." = FIELD("No."), "Sales Document Type" = CONST(Quote));
        }
        ...
        {
            CalcFormula = Sum("Insure Lines"."Gross Premium" WHERE("Document Type" = FIELD("Document Type"), "Document No." = FIELD("No.")));
            FieldClass = FlowField;
        }
        field(137; "Total TPO Premium"; Decimal)
        {
            CalcFormula = Sum("Insure Lines"."TPO Premium" WHERE("Document Type" = FIELD("Document Type"), "Document No." = FIELD("No.")));
            FieldClass = FlowField;
        }
        field(138; "Total PLL Premium"; Decimal)
        {
            CalcFormula = Sum("Insure Lines".PLL WHERE("Document Type" = FIELD("Document Type"), "Document No." = FIELD("No.")));
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("G/L Entry".Amount WHERE("Document No." = FIELD("No."), "Insurance Trans Type" = CONST(UPR)));
            FieldClass = FlowField;
        }
        field(5050; "UPR Reinsurance"; Decimal)
        {
            CalcFormula = Sum("G/L Entry".Amount WHERE("Document No." = FIELD("No."), "Insurance Trans Type" = CONST("Re-UPR")));
            FieldClass = FlowField;
        }
        field(5051; DAC; Decimal)
        {
            CalcFormula = Sum("G/L Entry".Amount WHERE("Document No." = FIELD("No."), "Insurance Trans Type" = CONST(DAC)));
            FieldClass = FlowField;
        }
    }
    ...
    var
        ...
        SalesInvoiceHeader: Record "Insure Credit Note";
    begin
    ...
    local procedure SendReport(ReportId: Integer; var SalesInvoiceHeader: Record "Insure Credit Note");
    var
