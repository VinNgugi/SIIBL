table 51513041 "Underwriter Policy Types"
{
    // version AES-INS 1.0
    ...
    fields
    {
        ...
        field(8; "Default Area Code"; Code[20])
        {
            TableRelation="Product Zones"."Zone ID" where ("Underwriter Code"=FIELD("Underwriter Code"),
            "Policy Type"=FIELD(Code));
        }
        ...
        field(94; "Underwriter Code"; Code[20])
        {
            TableRelation = Vendor."No.";

        }
        field(95; "Class of Insurance"; Code[40])
        {
           // TableRelation = "Insurance Class";
        }
        field(96; "Receive Insured Premiums?"; Boolean)

        { }
        field(97; "Commission Expense Account"; Code[20])
        {
            TableRelation = "G/L Account";
        }
        field(98; "Premium Payment Options"; Enum "Premium Payment Options")
        {

        }
        field(99; "Commission Calculation Basis";enum "Commission Calculation Basis")
        {
            
        }
        field(100;"Deffered Period";Dateformula)
        {

        }
        field(101;"Default Term";Code[20])
        {
            TableRelation="Product Terms"."Term Code" where ("Underwriter Code"=field("Underwriter Code"),"Product Code"=field(Code));
            trigger Onvalidate()
            var
            ProductTerm: Record "Product Terms";
            Term: record Term;
            begin
                If Term.GET("Default Term") then
                Period:=Term.Term;
            end;
        }
        field(102;"Surrender Value Period";Dateformula)
        {

        }
        field(103;"Partial maturity?";Boolean)
        {
    ...
    keys
    {
        key(Key1; "Code", "Underwriter code")
        {
        }
    }
