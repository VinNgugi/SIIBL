table 51513087 "Insure Debit Note Lines"
{
    // version AES-INS 1.0

    DrillDownPageID = 51513136;
    LookupPageID = 51513136;
    ...
    fields
    {
        ...
        field(47; "Copied from No."; Code[30])
        {
        }
        ...
        field(59; ft; Option)
        {
            OptionMembers = "0","1","2","3","Currency","5","6","7","8","9","10","11";
