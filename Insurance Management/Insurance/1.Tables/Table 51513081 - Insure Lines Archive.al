table 51513081 "Insure Lines Archive"
{
    // version AES-INS 1.0
            ...
            begin
                IF InsQuote.GET("Document Type", "Document No.") THEN BEGIN
                    IF PolicyType.GET(InsQuote."Policy Type") THEN
                        IF PolicyType."Premium Table" <> '' THEN BEGIN
                            ...
                            PremiumTableLines.SETRANGE(PremiumTableLines."Vehicle Type", "Vehicle Usage");
                            PremiumTableLines.SETRANGE(PremiumTableLines."Vehicle Type", "Vehicle License Class");
                            IF PremiumTableLines.FINDFIRST THEN BEGIN
