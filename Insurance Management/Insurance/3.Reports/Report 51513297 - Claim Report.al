report 51513297 "Claim Report"
{
    // version AES-INS 1.0

    DefaultLayout = RDLC;
    RDLCLayout = './Insurance/5.Layouts/Claim Report.rdl';
    ...
    dataset
    {
        dataitem("Claim"; "Claim")
        {
            ...
            column(TDD_Claim; Claim.TDD)
            {
            }
            column(PTD_Claim; Claim.PTD)
            {
            }
            ...
            column(CopyTo1_Claim; Claim."Copy To 1")
            {
            }
            column(CopyTo2_Claim; Claim."Copy To 2")
            {
            }
            column(CopyTo3_Claim; Claim."Copy To 3")
            {
            }
            ...
            column(TreatyNumber_Claim; Claim.TreatyNumber)
            {
            }
            column(AddendumCode_Claim; Claim."Addendum Code")
            {
            }
            ...
            begin
                ...
                IF Claim.GET(Insured) THEN
                    Insured := Claim."Name of Insured";
            end;
        }
    }
