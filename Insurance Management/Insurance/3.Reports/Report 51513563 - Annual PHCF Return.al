report 51513563 "Annual PHCF Return"
{
    // version AES-INS 1.0

    DefaultLayout = RDLC;
    RDLCLayout = './Insurance/5.Layouts/Annual PHCF Return.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                RequestFilterFields = "Global Dimension 1 Code", "Endorsement Type";
                ...
                begin
                    ...
                    IF PostedDebitNote.FIND('-') THEN BEGIN
                        ...
                        PostedDebitNote.CALCFIELDS(PostedDebitNote."Total Sum Insured", PostedDebitNote."Total Premium Amount");
                    ...
                    IF creditnote.FIND('-') THEN BEGIN
                        ...
                        creditnote.CALCFIELDS(creditnote."Total Net Premium", creditnote."Total Premium Amount");
