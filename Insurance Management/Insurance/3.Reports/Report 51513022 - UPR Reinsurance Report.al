report 51513022 "UPR Reinsurance Report"
{
    // version AES-INS 1.0

    DefaultLayout = RDLC;
    RDLCLayout = './Insurance/5.Layouts/UPR Reinsurance Report.rdl';
    ...
    dataset
    {
        dataitem("G/L Entry"; "G/L Entry")
        {
            DataItemTableView = SORTING("Insurance Trans Type", "Posting Date")
                                WHERE("Insurance Trans Type" = FILTER("Reinsurance Premium"));
            ...
            column(Total_UPR; TotalUPR)
            {
            }
            column(Total_Premium; TotalPremium)
            {
            }
            ...
            begin
                ...
                TotalPremium := TotalPremium + UPRGrossPremium + UPRReinsurancePremium;
                TotalUPR := TotalUPR + UPRGrossPremium + UPRReinsurancePremium;
