report 51513573 "Customer Statements"
{
    // version AES-INS 1.0

    DefaultLayout = RDLC;
    RDLCLayout = './Insurance/5.Layouts/Customer Statement.rdl';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            {
                DataItemLink = "Insured ID" = FIELD("No.");
                ...
                column(InsuredID_DetailedCustLedgEntry; "Detailed Cust. Ledg. Entry"."Insured ID")
                {
                }
