report 51513306 "Credit Note CIC"
{
    // version AES-INS 1.0

    DefaultLayout = RDLC;
    RDLCLayout = './Insurance/5.Layouts/Credit Note CIC.rdl';

    dataset
    {
        dataitem("Insure Credit Note"; "Insure Credit Note")
        {
            column(TotalNetPremium_InsureDebitNote; "Insure Credit Note"."Total Net Premium")
            {
            }
            ...
            column(EndorsementNo1; "Insure Credit Note"."Endorsement Policy No.")
            {
            }
            column(No_InsureHeader; "Insure Credit Note"."No.")
            {
            }
            column(InsuredNo_InsureHeader; "Insure Credit Note"."Insured No.")
            {
            }
            column(CoverPeriod_InsureHeader; "Insure Credit Note"."Cover Period")
            {
            }
            column(PolicyNo_InsureHeader; "Insure Credit Note"."Policy No")
            {
            }
            column(PolicyDescription_InsureDebitNote; "Insure Credit Note"."Policy Description")
            {
            }
            column(CoverTypeDescription_InsureDebitNote; "Insure Credit Note"."Cover Type Description")
            {
            }
            column(TotalSumInsured_InsureDebitNote; "Insure Credit Note"."Total Sum Insured")
            {
            }
            column(CoverType_InsureHeader; "Insure Credit Note"."Cover Type")
            {
            }
            column(CoverTypeDescription_InsureHeader; "Insure Credit Note"."Cover Type Description")
            {
            }
            column(PolicyClass_InsureHeader; "Insure Credit Note"."Policy Class")
            {
            }
            column(InsuredName_InsureHeader; "Insure Credit Note"."Insured Name")
            {
            }
            column(TotalSumInsured_InsureHeader; "Insure Credit Note"."Total Sum Insured")
            {
            }
            column(TotalPremiumAmount_InsureHeader; "Insure Credit Note"."Total Premium Amount")
            {
            }
            column(TotalDiscountAmount_InsureHeader; "Insure Credit Note"."Total  Discount Amount")
            {
            }
            column(TotalCommissionDue_InsureHeader; "Insure Credit Note"."Total Commission Due")
            {
            }
            column(TotalCommissionOwed_InsureHeader; "Insure Credit Note"."Total Commission Owed")
            {
            }
            column(TotalTrainingLevy_InsureHeader; "Insure Credit Note"."Total Training Levy")
            {
            }
            column(TotalStampDuty_InsureHeader; "Insure Credit Note"."Total Stamp Duty")
            {
            }
            column(TotalTax_InsureHeader; "Insure Credit Note"."Total Tax")
            {
            }
            column(FamilyName_InsureHeader; "Insure Credit Note"."Family Name")
            {
            }
            column(FirstNamess_InsureHeader; "Insure Credit Note"."First Names(s)")
            {
            }
            column(PremiumAmount_InsureDebitNote; "Insure Credit Note"."Premium Amount")
            {
            }
            column(Title_InsureHeader; "Insure Credit Note".Title)
            {
            }
            column(UndewriterName_InsureHeader; "Insure Credit Note"."Undewriter Name")
            {
            }
            column(AgentBroker_InsureDebitNote; "Insure Credit Note"."Agent/Broker")
            {
            }
            column(BrokersName_InsureDebitNote; "Insure Credit Note"."Brokers Name")
            {
            }
            column(CoverStartDate_InsureDebitNote; "Insure Credit Note"."Cover Start Date")
            {
            }
            column(CoverEndDate_InsureDebitNote; "Insure Credit Note"."Cover End Date")
            {
            }
            ...
            column(DocumentDate_InsureDebitNote; "Insure Credit Note"."Document Date")
            {
            }
            ...
            column(Occupation_InsureDebitNote; "Insure Credit Note".Occupation)
            {
            }
            column(EffectiveStartdate_InsureDebitNote; "Insure Credit Note"."Effective Start date")
            {
            }
            column(EmployeeFullName; EmployeeFullName)
            {
            }
            dataitem(MotorVehicles; "Insure Credit Note Lines")
            {
                ...
                column(MemberCode_InsureLines; MotorVehicles.Colour)
                {
                }
                ...
                column(Relationship2Applicant; MotorVehicles."Relationship to Applicant")
                {
                }
            ...
            dataitem(Taxes; "Insure Credit Note Lines")
            {
            ...
            trigger OnAfterGetRecord();
            begin
                IF Cust.GET("Insure Credit Note"."Insured No.") THEN
                ...
                GenLedgSetup.GET;
                BranchCode := "Insure Credit Note"."Shortcut Dimension 1 Code";
                IF DimValue.GET(GenLedgSetup."Global Dimension 1 Code", BranchCode) THEN
                    BranchName := DimValue.Name;
                //MESSAGE('%1 %2',BranchName,"Insure Credit Note"."Shortcut Dimension 1 Code");
                Cust.SETRANGE(Cust."No.", "Insure Credit Note"."Insured No.");
                CustName := Cust.Name;
                CustAddress := Cust.Address;

                EmployeeFullName := '';
                EmpTitle := '';
                UserSetupDetails.SETRANGE(UserSetupDetails."User ID", "Insure Credit Note"."Created By");
                ...
                //Agent Address
                Cust.RESET;
                Cust.SETRANGE(Cust."No.", "Insure Credit Note"."Agent/Broker");
                IF Cust.FIND('-') THEN
                ...
                IF PolicyType.GET("Insure Credit Note"."Policy Type") THEN BEGIN
    ...
    begin
        ...
        AllFilters := "Insure Credit Note".GETFILTERS;
    end;
