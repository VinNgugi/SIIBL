xmlport 51513002 "Import Motor vehicles"
{
    // version AES-INS 1.0
    ...
    schema
    {
        textelement(Vehicles)
        {
            tableelement("Insure Lines"; "Insure Lines")
            {
                XmlName = 'MV';
                fieldelement(RegNo; "Insure Lines"."Registration No.")
                {
                }
                fieldelement(Make; "Insure Lines".Make)
                {
                    FieldValidate = No;
                }
                fieldelement(YearofM; "Insure Lines"."Year of Manufacture")
                {
                }
                fieldelement(BodyType; "Insure Lines"."Type of Body")
                {
                    FieldValidate = No;
                }
                fieldelement(CC; "Insure Lines"."Cubic Capacity (cc)")
                {
                }
                fieldelement(SeatingCapacity; "Insure Lines"."Seating Capacity")
                {
                    FieldValidate = No;
                }
                fieldelement(Colour; "Insure Lines".Colour)
                {
                    FieldValidate = No;
                }
                fieldelement(EngineNo; "Insure Lines"."Engine No.")
                {
                }
                fieldelement(ChassisNo; "Insure Lines"."Chassis No.")
                {
                }
                fieldelement(SACCOID; "Insure Lines"."SACCO ID")
                {
                    FieldValidate = No;
                }
                fieldelement(RouteID; "Insure Lines"."Route ID")
                {
                    FieldValidate = No;
                }
                fieldelement(SumInsured; "Insure Lines"."Sum Insured")
                {
                }
