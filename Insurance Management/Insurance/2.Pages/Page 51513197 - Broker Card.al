page 51513197 "Broker Card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Certificate of Registration"; "Certificate of Registration")
                {
                }
                field(PIN; PIN)
                {
    ...
    begin
        "Customer Type" := "Customer Type"::"Agent/Broker";
        "Insured Type" := "Insured Type"::Broker;
        //MESSAGE('doing it');
        IF InsSetup.GET THEN BEGIN
            "Customer Posting Group" := InsSetup."Default Broker PG";
            "VAT Bus. Posting Group" := InsSetup."Default Broker WHT Group";
        END;
    end;
    ...
    var
        ...
        PremiumByAgentProd: Record "Premium by Agent and Product";
        PremiumByAgentClass: Record "Premium by Agent and Class";
