page 51513208 "Endorsement list -Risk"
{
    // version AES-INS 1.0
    ...
    SourceTableView = WHERE("Document Type"=CONST(Policy),
                            ...
                            "Action Type"=FILTER(Extension|Suspension|Substitution|Cancellation|Resumption|Revision|"Yellow Card"|"Additional Riders"|Nil));
