page 51513001 "Policy Type Card"
{
    // version AES-INS 1.0
    ...
    layout
    {
        area(content)
        {
            ...
            {
                SubPageLink = "Policy Type" = FIELD(Code), "Description Type" = CONST(Cover);
            }
            part("Interest Details"; "Interest Details")
            {
                SubPageLink = "Policy Type" = FIELD(Code), "Description Type" = CONST(Interest);
            }
