page 51513098 "Underwriter Card"
{
    Caption = 'Underwriter Card';
    PageType = List;
    UsageCategory = Lists;
    ...
    actions
    {
        area(navigation)
        {
            ...
            group(BrokerageContracts)
            {
                Caption='Broker Contracts';
                ...
                action(Plans)
                {
                    ...
                    Tooltip='View a list of Cover Plans';
        ...
        if GuiAllowed then
            if "No." = '' then
                if DocumentNoVisibility.VendorNoSeriesIsDefault then
                    NewMode := true;
        //bkk 11.03.2021
        "Vendor Type" := "Vendor Type"::Insurer;
       // MESSAGE('%1',"Vendor Type" );
    end;
    trigger OnOpenPage()
    var
