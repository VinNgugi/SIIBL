page 51513126 "Sales Agent Card"
{
    // version AES-INS 1.0

    Caption = 'Sales Agent Card';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Net Commission"; "Net Commission")
                {
                }
            ...
            group(Invoicing)
            {
                ...
                field("Invoice Copies"; "No. of Invoices")
                {
                }
    ...
    actions
    {
        area(navigation)
        {
            ...
            group("AgentCommissionSetup")
            {

                action("Agent Commission Setup")
                {
                    caption = 'Agent Commission Setup';
                    Image = Setup;
                    RunObject = Page "Agent Commissions";
    ...
    begin
        //bkk
        "Vendor Type" := "Vendor Type"::Agent;
        //"Insured Type" := "Insured Type"::Agent;
